    ...
    .then(commentList => {
        ...
        for(let comment of commentList){
            ...
            if(comment.commentDelFl == 'Y') {
                ...
                commentRow.style.fontSize = '15px';
                commentRow.style.color = 'rgb(85, 85, 85)';
                commentRow.style.marginLeft = '10px';
            } 
            ...
            if(comment.parentCommentNo != 0) {
                ...
                i.classList.add("fa", "fa-share", "fa-flip-vertical");
                nickname.classList.add('arrowNick');
                // commentWriter.classList.add('arrowArea')
                content.classList.add('arrowContent');
                // commentBtnArea.classList.add('arrowBtnArea');
                
                commentWriter.append(i, nickname, commentDate);
            }
...
const showInsertComment = (parentCommentNo, btn) => {
    ...
    const commentBtnArea = document.createElement("div");
    commentBtnArea.classList.add("comment-btn-area", "insert-cancel-area");
